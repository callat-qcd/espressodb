...
and the 2020 INCITE project titled *The Structure and Interactions of Nucleons from the Standard Model* [@incite:2020].
...
The main objective behind ``EspressoDB`` is to store vast amount of data and provide an easy to use framework which help make fast and informed decisions.
