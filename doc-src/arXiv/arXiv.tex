...
\title{EspressoDB: A scientific database for managing high-performance computing workflow}
      ...
      \affil[$\dagger$]{\textit {\href{mailto:christopher@ckoerber.com}{christopher@ckoerber.com}}}
...
\marginpar{
  ...
  \begin{itemize}
    ...
    \item \href{https://github.com/callat-qcd/espressodb}{\color{linky}{EspressoDB Repository}} \ExternalLink
    \item \href{https://github.com/callat-qcd/lattedb}{\color{linky}{LattedDB Repository}} \ExternalLink
    \item \href{https://ithems.lbl.gov/lattedb}{\color{linky}{LattedDB Webpage}} \ExternalLink
  \end{itemize}
  ...
  {\bfseries Submitted:} 06 December 2019\\
