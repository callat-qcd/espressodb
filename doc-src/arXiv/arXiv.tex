...
\title{EspressoDB: A scientific database for managing high-performance computing workflow}
        ...
        \author[2,3]{Christopher K{\"o}rber}
...
\marginpar{
  ...
  {\bfseries DOI:} \href{XXX}{\color{linky}{XXX}}
  ...
  \begin{itemize}
    ...
    \item \href{XXX}{\color{linky}{Review}} \ExternalLink
    \item \href{https://github.com/callat-qcd/espressodb}{\color{linky}{Repository}} \ExternalLink
    \item \href{https://github.com/callat-qcd/lattedb}{\color{linky}{Repository}} \ExternalLink
    \item \href{XXX}{\color{linky}{Archive}} \ExternalLink
  \end{itemize}

  \vspace{2mm}

  {\bfseries Submitted:} XX December 2019\\
