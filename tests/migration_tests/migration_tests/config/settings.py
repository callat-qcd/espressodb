"""
Django settings for migration_tests project.
...
ROOT_URLCONF = "migration_tests.config.urls"
...
WSGI_APPLICATION = "migration_tests.config.wsgi.application"
...
MIGRATION_MODULES = {"notifications": "migration_tests.config.migrations.notifications"}
