"""Prepares the usage of the migration_tests module
"""
import os
...
def _init():
    """Initializes the django environment for migration_tests
    """
    os.environ.setdefault("DJANGO_SETTINGS_MODULE", "migration_tests.config.settings")
    _setup()
