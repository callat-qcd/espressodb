"""
Django settings for espressodb_tests project.
...
ROOT_URLCONF = "espressodb_tests.config.urls"
...
WSGI_APPLICATION = "espressodb_tests.config.wsgi.application"
...
PROJECT_NAME = "espressodb_tests"

MIGRATION_MODULES = {"notifications": "espressodb_tests.config.migrations.notifications"}
