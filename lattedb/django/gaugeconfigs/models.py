...
class HisqGaugeConfig(GaugeConfig):
    ...
    stream = models.CharField(
        ...
        null=False,
        blank=False,
        help_text="Char(5): Stream tag of Monte Carlo (e.g. 'a')",
    )
    nl = models.PositiveSmallIntegerField(
        null=False, help_text="Integer: Spatial length in lattice units"
    )
    nt = models.PositiveSmallIntegerField(
        null=False, help_text="Integer: Temporal length in lattice units"
    )
