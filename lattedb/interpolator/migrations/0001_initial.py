    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('parity', models.PositiveSmallIntegerField(help_text='PositiveSmallIntegerField: Parity of hadronic operator')),
        ...
        migrations.AddConstraint(
            ...
            constraint=models.UniqueConstraint(fields=('interpolatorsmear', 'strangeness'), name='unique_interpolator'),
        ),
        migrations.AddConstraint(
            model_name='hadron4d',
            constraint=models.UniqueConstraint(fields=('interpolator_ptr_id', 'irrep', 'embedding', 'parity', 'spin_x2', 'spin_z_x2', 'isospin_x2', 'isospin_z_x2'), name='unique_hadron_hadron4d'),
        ),
        migrations.AddConstraint(
            model_name='hadron',
            constraint=models.UniqueConstraint(fields=('interpolator_ptr_id', 'irrep', 'embedding', 'parity', 'spin_x2', 'spin_z_x2', 'isospin_x2', 'isospin_z_x2', 'momentum'), name='unique_hadron_hadron'),
        ),
    ]
